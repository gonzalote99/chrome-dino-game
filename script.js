...
function setDinoLose() {
  dino.src = "https://raw.githubusercontent.com/wasimreja/chrome-dino-game/main/assets/dino-lose.png"
}

function handleRun(delta, speedScale) {
if (isJumping) {
  dino.src = `https://raw.githubusercontent.com/wasimreja/chrome-dino-game/main/assets/dino-stationary.png`;
  return;
}

if(currentFrameTime >= FRAME_TIME) {
  dinoFrame = (dinoFrame + 1) % DINO_FRAME_COUNT;
  dino.src = `https://raw.githubusercontent.com/wasimreja/chrome-dino-game/main/assets/dino-run-${dinoFrame}.png`;
...
function createCactus() {
  ...
  cactus.src = "https://raw.githubusercontent.com/wasimreja/chrome-dino-game/main/assets/cactus.png";
